                                            ...
                                            >
                                                ...
                                                <div className="pt-4 flex items-center gap-x-5">
                                                    <div className="grow">
                                                        ...
                                                        <h4 className="mt-2 text-sm sm:text-base text-gray-800 dark:text-neutral-200">
                                                            Modals provide a clean way to present filter options
                                                            inside modal windows.
                                                        </h4>
                                                    </div>
                                                    <div>
                      <span className="flex shrink-0 justify-center items-center size-10 bg-white border border-gray-100 text-gray-800 rounded-full group-hover:bg-blue-100 group-hover:border-blue-100 group-hover:text-blue-600 group-focus:bg-blue-100 group-focus:border-blue-100 group-focus:text-blue-600 dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-200 dark:group-hover:bg-blue-800/50 dark:group-hover:border-blue-800/10 dark:group-hover:text-blue-500 dark:group-focus:bg-blue-800/10 dark:group-focus:border-blue-800/50 dark:group-focus:text-blue-500">
                                            ...
                                            >
                                                ...
                                                <div className="pt-4 flex items-center gap-x-5">
                                                    <div className="grow">
                                                        ...
                                                        <h4 className="mt-2 text-sm sm:text-base text-gray-800 dark:text-neutral-200">
                                                            Simplified checkout process with intuitive forms to
                                                            ensure a smooth and quick transaction completion.
                                                        </h4>
                                                    </div>
                                                    <div>
                      <span className="flex shrink-0 justify-center items-center size-10 bg-white border border-gray-100 text-gray-800 rounded-full group-hover:bg-blue-100 group-hover:border-blue-100 group-hover:text-blue-600 group-focus:bg-blue-100 group-focus:border-blue-100 group-focus:text-blue-600 dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-200 dark:group-hover:bg-blue-800/50 dark:group-hover:border-blue-800/10 dark:group-hover:text-blue-500 dark:group-focus:bg-blue-800/10 dark:group-focus:border-blue-800/50 dark:group-focus:text-blue-500">
                                            ...
                                            >
                                                ...
                                                <div className="pt-4 flex items-center gap-x-5">
                                                    <div className="grow">
                                                        ...
                                                        <h4 className="mt-2 text-sm sm:text-base text-gray-800 dark:text-neutral-200">
                                                            Create customizable review forms with pre-set questions
                                                            to guide reviewers.
                                                        </h4>
                                                    </div>
                                                    <div>
                                            ...
                                            >
                                                ...
                                                <div className="pt-4 flex items-center gap-x-5">
                                                    <div className="grow">
                                                        ...
                                                        <h4 className="mt-2 text-sm sm:text-base text-gray-800 dark:text-neutral-200">
                                                            Dive deeper with data maps, customizable tabs and
                                                            insightful tables, all in one centralized dashboard.
                                                        </h4>
                                                    </div>
                                                    <div>
                      <span className="flex shrink-0 justify-center items-center size-10 bg-white border border-gray-100 text-gray-800 rounded-full group-hover:bg-blue-100 group-hover:border-blue-100 group-hover:text-blue-600 group-focus:bg-blue-100 group-focus:border-blue-100 group-focus:text-blue-600 dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-200 dark:group-hover:bg-blue-800/50 dark:group-hover:border-blue-800/10 dark:group-hover:text-blue-500 dark:group-focus:bg-blue-800/10 dark:group-focus:border-blue-800/50 dark:group-focus:text-blue-500">
                        ...
                        <div className="max-w-4xl px-4 sm:px-6 lg:px-8 mx-auto">
                            ...
                            <div className="mb-8 md:mb-16 max-w-xl mx-auto text-center">
                                ...
                                <h2 className="font-semibold text-2xl md:text-3xl text-gray-800 dark:text-neutral-200">
                                    Since 2007, we have helped 2.5k+ companies launch over 100k
                                    incredible products
                                </h2>
                            </div>
                            {/* End Heading */}
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-6 sm:gap-x-10 lg:gap-y-12 lg:gap-x-16">
                                ...
                                <div className="flex gap-5">
                                    ...
                                    <div className="grow">
                                        ...
                                        <p className="mt-1 text-gray-500 dark:text-neutral-500">
                                            We dedicate time for researching and experimentation to increase
                                            creativity and imagine new challenges.
                                        </p>
                                    </div>
                                </div>
                                {/* End Icon Block */}
                  ...
                  >
                    ...
                    />
                                    ...
                                    <div className="mb-5">
                                        ...
                                        <p className="mt-1 text-gray-500 dark:text-neutral-500">
                                            Gitlab spent the equivalent of $25k per year in spreadsheet
                                            processes. Now Preline does it for them.
                                        </p>
                                    </div>
                                </a>
                                {/* End Card */}
                    ...
                    />
                                    ...
                                    <div className="mb-5">
                                        ...
                                        <p className="mt-1 text-gray-500 dark:text-neutral-500">
                                            ...
                                            GitLab's comprehensive suite of tools.
                                        </p>
                                    </div>
                                </a>
                                {/* End Card */}
                                            ...
                                            <div className="p-4 md:p-6 relative z-10 flex flex-col justify-end gap-3">
                                                ...
                                                <div className="mt-1.5 md:mt-3">
                                                    <blockquote className="md:text-xl text-white">
                                                        ...
                                                        to detail the team at Preline have put into this project
                                                        and for one can guarantee that we will be a return
                                                        customer.
                                                        <footer className="mt-4 md:mt-6 text-sm">
                                                            Luisa,{" "}
                                                            <span className="opacity-70">Director of Canva</span>
                                                        </footer>
                                                    </blockquote>
                                                </div>
                                            </div>
                                            ...
                                            <div className="p-4 md:p-6 relative z-10 flex flex-col justify-end gap-3">
                                                ...
                                                <div className="mt-1.5 md:mt-3">
                                                    <blockquote className="md:text-xl text-white">
                                                        ...
                                                        <footer className="mt-4 md:mt-6 text-sm">
                                                            Josh Tyson,{" "}
                                                            <span className="opacity-70">CEO of Asana</span>
                                                        </footer>
                                                    </blockquote>
                                                </div>
                                            </div>
