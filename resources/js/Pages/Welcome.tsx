        ...
        <GuestLayout title="Welcome">
            <>
                ...
                <main id="content">
                    {/* Hero */}
                    <div
                        className="relative bg-[url(../img/pro/startup/img11.webp)] dark:bg-[url(../img/pro/startup-dark/img11.webp)] bg-no-repeat bg-cover bg-top">
                        <div className="pt-10 md:pt-20 pb-14 md:pb-20 relative z-10">
                            <div className="max-w-6xl px-4 sm:px-6 lg:px-8 mx-auto">
                                {/* Grid */}
                                <div
                                    className="mb-4 md:mb-8 grid md:grid-cols-12 items-center gap-y-12 gap-x-5 lg:gap-x-8">
                                ...
                                <span className="font-medium text-sm text-gray-800 dark:text-neutral-200">
                                  MacOS
                                                            ...
                                                            <li className="ms-auto inline-flex items-center gap-x-0.5">
                                                                ...
                                                                <span
                                                                    className="font-medium text-xs text-gray-800 dark:text-neutral-200">
                                  4.9
                                </span>
                                                            </li>
                                                            <li className="inline-flex items-center gap-x-1">
                                ...
                                <div className="space-y-2">
                                    ...
                                    {/* Browser */}
                                    <div
                                        className="p-1.5 md:p-3 bg-white/40 border border-white/50 rounded-xl shadow-lg dark:bg-white/[.05] dark:border-white/10">
                                        {/* Header */}
                                        <div className="mb-1 h-4 md:h-6 flex items-center">
                                            {/* Dots */}
                                            <div className="flex gap-x-1.5 md:gap-x-2 px-2.5 md:px-3.5">
                                                <span
                                                    className="size-2.5 md:size-3 bg-red-400 border border-red-500 rounded-full shadow-inner dark:bg-red-600 dark:border-red-600"/>
                                                <span
                                                    className="size-2.5 md:size-3 bg-yellow-400 border border-yellow-500 rounded-full shadow-inner dark:bg-yellow-600 dark:border-yellow-600"/>
                                                <span
                                                    className="size-2.5 md:size-3 bg-green-400 border border-green-500 rounded-full shadow-inner dark:bg-green-600 dark:border-green-600"/>
                                            </div>
                                            {/* End Dots */}
                                        </div>
                                        {/* End Header */}
    ...
    "isDraggable": true
                        ...
                        >
                          <path d="m9 18 6-6-6-6"/>
                                ...
                                <div className="hs-carousel w-full">
                                    <div
                                        className="hs-carousel-body flex flex-nowrap gap-3 md:gap-5 opacity-0 transition-transform duration-700 cursor-grab hs-carousel-dragging:transition-none hs-carousel-dragging:cursor-grabbing">
                                        <div className="hs-carousel-slide">
                                            ...
                                            >
                                                <div className="relative">
                                                    <div
                                                        className="pt-6 ps-6 sm:pt-10 sm:ps-10 relative z-10 overflow-hidden ms-auto">
                                                        <img
                                                ...
                                                <div className="pt-4 flex items-center gap-x-5">
                                                    <div className="grow">
                                                        ...
                                                        <h4 className="mt-2 text-sm sm:text-base text-gray-800 dark:text-neutral-200">
                                                            Discover user-friendly calendar UIs designed for both
                                                            dashboard and
                                                            admin interfaces.
                                                        </h4>
                                                    </div>
                                            ...
                                            >
                                                ...
                                                <div className="pt-4 flex items-center gap-x-5">
                                                    <div className="grow">
                                                        ...
                                                        <h4 className="mt-2 text-sm sm:text-base text-gray-800 dark:text-neutral-200">
                                                            Modals provide a clean way to present filter options inside
                                                            modal
                                                            windows.
                                                        </h4>
                                                    </div>
                                            ...
                                            >
                                                ...
                                                <div className="pt-4 flex items-center gap-x-5">
                                                    <div className="grow">
                                                        ...
                                                        <h4 className="mt-2 text-sm sm:text-base text-gray-800 dark:text-neutral-200">
                                                            Simplified checkout process with intuitive forms to ensure a
                                                            smooth
                                            ...
                                            >
                                                ...
                                                <div className="pt-4 flex items-center gap-x-5">
                                                    <div className="grow">
                                                        ...
                                                        <h4 className="mt-2 text-sm sm:text-base text-gray-800 dark:text-neutral-200">
                                                            Create customizable review forms with pre-set questions to
                                                            guide
                                                            reviewers.
                                                        </h4>
                                                    </div>
                                            ...
                                            >
                                                ...
                                                <div className="pt-4 flex items-center gap-x-5">
                                                    <div className="grow">
                                                        ...
                                                        <h4 className="mt-2 text-sm sm:text-base text-gray-800 dark:text-neutral-200">
                                                            Powerful e-commerce admin pages with product &amp; order
                                                            lists,
                                                            referrals and more.
                                                        </h4>
                                                    </div>
                                            ...
                                            >
                                                ...
                                                <div className="pt-4 flex items-center gap-x-5">
                                                    <div className="grow">
                                                        ...
                                                        <h4 className="mt-2 text-sm sm:text-base text-gray-800 dark:text-neutral-200">
                                                            Dive deeper with data maps, customizable tabs and insightful
                                                            tables,
                    ...
                    <div className="lg:pt-10 pb-20">
                        <div className="max-w-4xl px-4 sm:px-6 lg:px-8 mx-auto">
                            ...
                            {/* Grid */}
                            <div
                                className="grid grid-cols-1 sm:grid-cols-2 gap-y-6 sm:gap-x-10 lg:gap-y-12 lg:gap-x-16">
                                {/* Icon Block */}
                    ...
                    <div className="max-w-6xl px-4 sm:px-6 lg:px-8 mx-auto">
                        <div
                            className="md:-mx-4 xl:-mx-20 p-4 pt-6 xl:p-20 bg-linear-to-b from-gray-100 to-transparent rounded-2xl dark:from-neutral-800">
                            {/* Heading */}
                            <div className="mb-8 md:mb-16 max-w-xl mx-auto text-center">
                                <h2 className="font-semibold text-2xl md:text-3xl text-gray-800 dark:text-neutral-200">
                                    Success stories
                    ...
                    <div className="pt-10 pb-20">
                        <div className="max-w-6xl px-4 sm:px-6 lg:px-8 mx-auto">
                            ...
                            {/* Grid */}
                            <div
                                className="relative overflow-hidden before:absolute before:inset-y-0 before:start-0 before:z-1 before:w-20 before:h-full before:bg-linear-to-r before:from-white before:to-transparent after:absolute after:inset-y-0 after:end-0 after:z-1 after:w-20 after:h-full after:bg-linear-to-l after:from-white after:to-transparent dark:before:from-neutral-900 dark:after:from-neutral-900">
                        ...
                        <span className="grow">
                          <span className="block font-medium text-lg text-gray-800 dark:text-neutral-200">
                            Advanced tools
                                            ...
                                            >
                                                <p className="mt-2 text-gray-500 dark:text-neutral-400">
                                                    Use Preline thoroughly thought and automated libraries to manage
                                                    your
                                                    businesses.
                                                </p>
                        ...
                        <span className="grow">
                          <span className="block font-medium text-lg text-gray-800 dark:text-neutral-200">
                            Smart dashboards
                                            ...
                                            >
                                                <p className="mt-2 text-gray-500 dark:text-neutral-400">
                                                    Quickly Preline sample components, copy-paste codes, and start right
                                                    off.
                                                </p>
                                                <ul className="mt-3 space-y-1">
                                                    <li className="flex items-center gap-x-1 text-gray-500 dark:text-neutral-400">
                            ...
                            Powerful features
                                ...
                                <div className="hs-accordion-outside-group relative h-96 md:h-150 w-full">
                                    ...
                                    >
                                        ...
                                        />
                                        <div
                                            className="absolute bottom-0 inset-x-0 after:absolute after:inset-0 after:size-full after:z-1 after:rounded-xl after:bg-linear-to-t after:from-blue-600 after:to-transparent">
                                            <div className="p-4 md:p-6 relative z-10 flex flex-col justify-end gap-3">
                                                ...
                                                <div className="mt-1.5 md:mt-3">
                                                    <blockquote className="md:text-xl text-white">
                                                        ...
                                                        detail the
                                                        team at Preline have put into this project and for one can
                                                        guarantee
                                    ...
                                    >
                                        ...
                                        />
                                        <div
                                            className="absolute bottom-0 inset-x-0 after:absolute after:inset-0 after:size-full after:z-1 after:rounded-xl after:bg-linear-to-t after:from-violet-600 after:to-transparent">
                                            <div className="p-4 md:p-6 relative z-10 flex flex-col justify-end gap-3">
                                                <div>
                                                    <svg
                                                        className="shrink-0 w-auto h-6 md:h-8 text-white"
                                    ...
                                    >
                                        ...
                                        />
                                        <div
                                            className="absolute bottom-0 inset-x-0 after:absolute after:inset-0 after:size-full after:z-1 after:rounded-xl after:bg-linear-to-t after:from-orange-600 after:to-transparent">
                                            <div className="p-4 md:p-6 relative z-10 flex flex-col justify-end gap-3">
                                                <div>
                                                    <svg
                                                        className="shrink-0 w-auto h-6 md:h-8 text-white"
                                        ...
                                        >
                                            <div className="pt-3">
                                                <p className="text-gray-800 dark:text-neutral-200">
                                                    ...
                                                    got you
                                                    covered. You can login to your account, tap your avatar in the upper
                                                    right
                                                    corner, and tap Purchases. If you didn't create a login or can't
                                                    remember
                                                    the information, you can use our handy Redownload page, just
                                                    remember to
                                        ...
                                        >
                                            <div className="pt-3">
                                                <p className="text-gray-800 dark:text-neutral-200">
                                                    ...
                                                    original
                                                    type you purchased and we have a solution that ensures you can apply
                                                    your
                    ...
                    <div className="max-w-6xl px-4 sm:px-6 lg:px-8 mx-auto">
                        <div
                            className="md:-mx-4 xl:-mx-20 px-4 py-6 md:py-12 xl:p-20 bg-linear-to-b from-gray-100 to-transparent rounded-2xl dark:from-neutral-800">
