                ...
                <div>
                  <div className="flex items-center gap-x-2">
                    ...
                    >
                      I accept the
                      <a
                        className="inline-flex items-center gap-x-1.5 font-medium text-blue-600 hover:text-blue-700 decoration-2 hover:underline dark:text-blue-500 dark:focus:outline-hidden dark:focus:ring-1 dark:focus:ring-neutral-600"
                        href="#"
                      >
