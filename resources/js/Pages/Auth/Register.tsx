...
export default function Register({
    ...
    jetstream: { hasTermsAndPrivacyPolicyFeature: boolean };
}) {
        ...
        <AuthLayout title={"Sign up"}>
            ...
            <div className="grow px-5">
                <div className="h-full min-h-screen sm:w-112 flex flex-col justify-center mx-auto space-y-5">
                    ...
                    <div
                        className="flex items-center text-xs text-gray-400 uppercase before:flex-1 before:border-t before:border-gray-200 before:me-6 after:flex-1 after:border-t after:border-gray-200 after:ms-6 dark:text-neutral-500 dark:before:border-neutral-700 dark:after:border-neutral-700">
                        Or
                    </div>
                    ...
                    <form onSubmit={submit}>
                      ...
                      "target": ["#hs-pro-dappnp", "#hs-pro-dapprnp"]
                                ...
                                <div>
                                    <div className="flex items-center gap-x-2">
                                        <input
                                            type="checkbox"
                                            checked={data.terms}
                                            className="shrink-0 border-gray-200 size-3.5 rounded-sm text-yellow-600 focus:ring-offset-0 dark:bg-neutral-800 dark:checked:bg-yellow-950 dark:border-neutral-700"
                                            id="hs-pro-dsftac"
                                        ...
                                        >
                                            I accept the
                                            <a
                                                className="inline-flex items-center gap-x-1.5 font-medium text-yellow-600 hover:text-yellow-700 decoration-2 hover:underline dark:text-yellow-500 dark:focus:outline-hidden dark:focus:ring-1 dark:focus:ring-neutral-600"
                                                href="#"
                                            >
                            ...
                            <MainButton asType={"button"} type={"submit"} customClassName={"w-full"}
                                        disabled={processing} title={"Sign up"}/>
                    ...
                    <p className="text-sm text-gray-500 dark:text-neutral-500">
                        ...
                        <Link
                            className="inline-flex items-center gap-x-1 text-sm text-yellow-700 decoration-2 hover:underline font-medium focus:outline-hidden focus:underline dark:text-yellow-500"
                            href="/login"
                        >
                            Sign in
                            <svg
