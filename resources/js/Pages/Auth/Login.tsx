                ...
                <div className="grow px-5">
                    <div className="h-full min-h-screen sm:w-112 flex flex-col justify-center mx-auto space-y-5">
                            ...
                            <div className="space-y-5">
                                ...
                                <div>
                                    <div className="flex justify-between items-center mb-2">
                                        ...
                                        <a className="inline-flex items-center gap-x-1.5 text-xs text-gray-600 hover:text-gray-700 decoration-2 hover:underline focus:outline-hidden focus:underline dark:text-neutral-500 dark:hover:text-neutral-600"
                                           href="#">
                      ...
                      "target": "#hs-pro-dalp"
                                ...
                                <button type="submit"
                                        className="cursor-pointer py-2.5 px-3 w-full inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-hidden dark:focus:ring-1 dark:focus:ring-neutral-600" disabled={processing}>
                                    Sign in
                                </button>
                            </div>
                        </form>
