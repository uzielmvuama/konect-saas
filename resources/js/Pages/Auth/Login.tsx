                    ...
                    <div className="h-full min-h-screen sm:w-112 flex flex-col justify-center mx-auto space-y-5">
                        ...
                        <form>
                            <div className="space-y-5">
                                <div>
                                    ...
                                    <input type="email" id="hs-pro-dale" className="py-2 sm:py-2.5 px-3 block w-full border-gray-200 rounded-lg sm:text-sm placeholder:text-gray-400 focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-transparent dark:border-neutral-700 dark:text-neutral-300 dark:placeholder:text-white/60 dark:focus:ring-neutral-600" placeholder="you@email.com" />
                                </div>

                                <div>
                                    <div className="flex justify-between items-center mb-2">
                                        <label htmlFor="hs-pro-dalp" className="block text-sm font-medium text-gray-800 dark:text-white">
                                            Password
                                        </label>

                                        <a className="inline-flex items-center gap-x-1.5 text-xs text-gray-600 hover:text-gray-700 decoration-2 hover:underline focus:outline-hidden focus:underline dark:text-neutral-500 dark:hover:text-neutral-600" href="#">
                                            I forgot my password
                                        </a>
                                    </div>

                                    <div className="relative">
                                        <input id="hs-pro-dalp" type="password" className="py-2 sm:py-2.5 px-3 block w-full border-gray-200 rounded-lg sm:text-sm placeholder:text-gray-400 focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-transparent dark:border-neutral-700 dark:text-neutral-300 dark:placeholder:text-white/60 dark:focus:ring-neutral-600" placeholder="********" />
                      ...
                      "target": "#hs-pro-dalp"
                        ...
                        <p className="text-sm text-gray-500 dark:text-neutral-500">
                            New to Preline?
                            <a className="inline-flex items-center gap-x-1 text-sm text-blue-600 decoration-2 hover:underline font-medium focus:outline-hidden focus:underline dark:text-blue-500" href="#">
                                Sign up
