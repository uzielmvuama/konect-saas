              ...
              "max": 0
                      ...
                      <ul className="mt-7 space-y-2.5 text-sm">
                        ...
                        <li className="flex items-center gap-x-3">
                          ...
                          <span className="text-gray-800 dark:text-neutral-400">Email Support</span>
                        </li>
                        <li className="flex items-center gap-x-3">
                          <svg
                            className="shrink-0 size-4 text-gray-800 dark:text-neutral-200"
                  ...
                  <ul className="grid lg:grid-cols-6 lg:gap-6">
                    ...
                    <li className="col-span-1 py-1.5 lg:py-3 border-b border-gray-200 dark:border-neutral-700">
                      <div className="grid grid-cols-2 md:grid-cols-6 lg:block">
                        ...
                        <span className="text-sm text-gray-800 dark:text-neutral-200">Up to 3</span>
                      </div>
                    </li>
                    {/* End Item */}
                    {/* Item */}
                  ...
                  <ul className="grid lg:grid-cols-6 lg:gap-6">
                    ...
                    <li className="col-span-1 py-1.5 lg:py-3 border-b border-gray-200 dark:border-neutral-700">
                      <div className="grid grid-cols-2 md:grid-cols-6 lg:block">
                        ...
                        <span className="text-sm text-gray-800 dark:text-neutral-200">15 GB</span>
                      </div>
                    </li>
                    {/* End Item */}
                    {/* Item */}
                    <li className="col-span-1 py-1.5 lg:py-3 border-b border-gray-200 dark:border-neutral-700">
                      <div className="grid grid-cols-2 md:grid-cols-6 lg:block">
                        ...
                        <span className="text-sm text-gray-800 dark:text-neutral-200">1 TB</span>
                      </div>
                    </li>
                    {/* End Item */}
                    {/* Item */}
                    <li className="col-span-1 py-1.5 lg:py-3 border-b border-gray-200 dark:border-neutral-700">
                      <div className="grid grid-cols-2 md:grid-cols-6 lg:block">
                        ...
                        <span className="text-sm text-gray-800 dark:text-neutral-200">15 TB</span>
                      </div>
                    </li>
                    {/* End Item */}
                    {/* Item */}
