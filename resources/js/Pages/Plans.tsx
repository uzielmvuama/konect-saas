        ...
        <GuestLayout title="Plans">
            <>
                ...
                <main id="content">
                    {/* Hero */}
                    <div
                        className="relative py-10 md:py-14 px-4 before:absolute before:inset-0 before:-z-1 before:mx-3 lg:before:mx-6 2xl:before:mx-10 before:bg-linear-to-b before:from-gray-100 before:to-transparent before:rounded-2xl dark:before:from-neutral-800">
                        <div className="max-w-6xl px-4 sm:px-6 lg:px-8 mx-auto">
                            ...
                            {/* End Heading */}
                            {/* Switch */}
                            <div id="toggle-count" className="flex justify-center items-center gap-x-3">
                                <label
                                ...
                                >
                                    ...
                                    />
                                    <span
                                        className="absolute inset-0 bg-gray-200 rounded-full transition-colors duration-200 ease-in-out peer-checked:bg-blue-600 dark:bg-neutral-700 dark:peer-checked:bg-blue-500 peer-disabled:opacity-50 peer-disabled:pointer-events-none"/>
                                    <span
                                        className="absolute top-1/2 start-0.5 -translate-y-1/2 size-5 bg-white rounded-full shadow-sm transition-transform duration-200 ease-in-out peer-checked:translate-x-full dark:bg-neutral-400 dark:peer-checked:bg-white"/>
                                </label>
                                <label
                                    htmlFor="pricing-switch"
                                    className="text-sm text-gray-800 dark:text-neutral-200"
                        ...
                        <div className="my-8">
                            <div className="max-w-[85rem] px-4 sm:px-6 lg:px-8 mx-auto">
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                                    {/* Card */}
                                    <div
                                        className="p-4 md:p-6 h-full flex flex-col bg-white border border-gray-200 rounded-xl shadow-xs dark:bg-neutral-900 dark:border-neutral-700">
                                        {/* Header */}
              ...
              "max": 0
                          ...
                          USD
                            ...
                            100 Build Minutes/month
                                                ...
                                                <li className="flex items-center gap-x-3">
                                                    ...
                                                    <span
                                                        className="text-gray-800 dark:text-neutral-400">Email Support</span>
                                                </li>
                                                <li className="flex items-center gap-x-3">
                                                    <svg
                                                        className="shrink-0 size-4 text-gray-800 dark:text-neutral-200"
                                                    ...
                                                    <div
                                                        ...
                                                        <header className="flex flex-col">
                                                            <h4 className="font-semibold text-lg text-gray-800 dark:text-neutral-200">
                                                                {plan.name}
                                                                {plan.slug == 'pro' && <span
                                                                    className="font-mono font-normal text-xs text-blue-600 dark:text-blue-500">
                          — Most popular
                        </span>}
                                                            </h4>
                                                            <div className="mt-2">
                        ...
                        <span className="font-semibold text-gray-800 text-xl dark:text-neutral-200">
                          $
                                                                ...
                                                                <span
                                                                    data-hs-toggle-count={JSON.stringify({
                                                                        "target": "#toggle-count",
                                                                        "min": plan.price,
                                                                        "max": plan.price * 12,
                                                                    })}
                          ...
                          {plan.price}
                                                                ...
                                                                <span
                                                                    className="block mt-0.5 text-gray-800 dark:text-neutral-200">
                          USD
                        </span>
                                                            </div>
                                                            {/* End Price */}
                                                            ...
                                                            <div
                                                                className="mt-5 pb-7 border-b border-gray-200 dark:border-neutral-700">
                                                                <a
                                                                    href={`/checkout/subscribe/${plan.id}`}
                        ...
                        <div className="max-w-2xl px-4 sm:px-6 lg:px-8 mx-auto">
                            {/* Card */}
                            <div
                                className="p-4 bg-white border border-gray-200 rounded-xl dark:bg-neutral-900 dark:border-neutral-700">
                    ...
                    <div className="pt-14 lg:pt-24">
                        <div className="max-w-6xl px-4 sm:px-6 lg:px-8 mx-auto">
                            ...
                            <div className="relative">
                                ...
                                {/* Header */}
                                <div
                                    className="hidden lg:block sticky top-16 start-0 py-2 bg-white border-b border-gray-200 dark:bg-neutral-900 dark:border-neutral-700">
                                    {/* Grid */}
                      ...
                      <span className="font-semibold lg:font-normal text-sm text-gray-800 dark:text-neutral-200">
                        ...
                        <span className="lg:hidden md:col-span-2 text-sm text-gray-800 dark:text-neutral-200">
                          Startup
                                                ...
                                                <span
                                                    className="text-sm text-gray-800 dark:text-neutral-200">Up to 3</span>
                                            </div>
                                        </li>
                                        {/* End Item */}
                                        {/* Item */}
                      ...
                      <span className="font-semibold lg:font-normal text-sm text-gray-800 dark:text-neutral-200">
                        ...
                        <span className="lg:hidden md:col-span-2 text-sm text-gray-800 dark:text-neutral-200">
                          Free
                                                ...
                                                <span
                                                    className="text-sm text-gray-800 dark:text-neutral-200">15 GB</span>
                                            </div>
                                        </li>
                                        {/* End Item */}
                                        {/* Item */}
                        ...
                        <span className="lg:hidden md:col-span-2 text-sm text-gray-800 dark:text-neutral-200">
                          Startup
                                                ...
                                                <span
                                                    className="text-sm text-gray-800 dark:text-neutral-200">1 TB</span>
                                            </div>
                                        </li>
                                        {/* End Item */}
                                        {/* Item */}
                        ...
                        <span className="lg:hidden md:col-span-2 text-sm text-gray-800 dark:text-neutral-200">
                          Team
                                                ...
                                                <span
                                                    className="text-sm text-gray-800 dark:text-neutral-200">15 TB</span>
                                            </div>
                                        </li>
                                        {/* End Item */}
                                        {/* Item */}
