      ...
      <div className="py-20 max-w-lg mx-auto">
        ...
        <div className="mb-5 sm:mb-8 text-center">
          ...
          <p className="text-sm text-gray-500 dark:text-neutral-500">
            We've scheduled a transfer of 52.25 USD to your Preline balance. This transfer will be
            sent from your USD Debit Card.
          </p>
        </div>
        {/* End Heading */}
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-3">
          <a
            className="py-3 px-4 inline-flex justify-center items-center gap-x-1.5 font-medium text-sm rounded-xl border border-transparent bg-purple-500 text-white hover:bg-purple-600 disabled:opacity-50 disabled:pointer-events-none focus:outline-hidden focus:bg-purple-600"
          ...
          <a
            ...
            href="../../pro/payment/add-money.html"
          >
            Add another money
            <svg
