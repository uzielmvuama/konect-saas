...
const NFCCard: React.FC<CreditCardProps> = ({
  ...
  return (
    <div
      className={clsx(
        `${type == "bottom" ? "py-5 " : "sm:py-5 py-5 "} px-4 relative w-full flex flex-col justify-between text-start rounded-xl`,
        bgColor
      )}
    >
      <div
      ...
      <div className="w-full flex justify-between items-center">
        <div className="grow">
          <div className="flex flex-wrap items-center whitespace-nowrap gap-2">
            <span
              className={clsx(
                "inline-flex items-center relative font-mono font-medium",
                iconColorClass
              )}
            >
              {firstname}
            ...
            <span
              className={clsx(
                "inline-flex items-center relative font-mono font-medium ps-1",
                iconColorClass,
          ...
          <span className={clsx("block font-mono text-sm", iconColorClass)}>{title}</span>
        </div>
