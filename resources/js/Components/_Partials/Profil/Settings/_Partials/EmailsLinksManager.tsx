                    ...
                    <div className="space-y-2" id="emails-wrapper">
                        {emails.map((email, index) => (
                            <div className="relative" key={index}>
                                <input type="text" id="hs-inline-leading-select-label" name="inline-add-on" className="py-2.5 sm:py-3 px-4 ps-32 block w-full border-gray-200 rounded-lg sm:text-sm focus:z-10 focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600" placeholder="test.example.com" />
                                <div className="absolute inset-y-0 start-0 flex items-center text-gray-500 ps-px">
                                    ...
                                    <select id="hs-inline-leading-select-country" name="hs-inline-leading-select-country" className="block w-full border-transparent rounded-lg focus:ring-blue-600 focus:border-blue-600 dark:text-neutral-500 dark:bg-neutral-900">
