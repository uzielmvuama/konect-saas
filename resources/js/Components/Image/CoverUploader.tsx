...
export default function CoverUploader({  initialCover, sftpRootPath = '' }: Props) {
    const {
        imageSrc, crop, zoom, aspect, isVisible, processing, progress, errors,
        setCrop, setZoom, setIsVisible, onCropComplete, handleFileChange, handleSave
    } = useImageCropUpload({
        type: 'cover',
        aspect: 16 / 9,
            ...
            <figure className="w-full">
                ...
                >
                    <g clipPath="url(#clip0_666_220723)">
                        ...
                        <path d="M512.694 359.31C547.444 172.086 469.835 34.2204 426.688 -11.3096H1144.27V359.31H512.694Z" fill="#C0CBDD" />
                        <path d="M818.885 185.745C703.515 143.985 709.036 24.7949 726.218 -29.5801H1118.31V331.905C1024.49 260.565 963.098 237.945 818.885 185.745Z" fill="#8192B0" />
                        <defs>
            ...
            <div className="absolute top-4 end-4">
                ...
                >
                    <div className="flex items-center">
                        <label htmlFor="file-upload-cover" className="cursor-pointer font-normal flex gap-x-2 items-center">
