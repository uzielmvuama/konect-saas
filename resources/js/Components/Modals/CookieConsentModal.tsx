    ...
    return (
        <div className="fixed inset-0 z-60 w-full flex justify-center items-center mx-auto p-6 bg-gray-100/50 dark:bg-neutral-800/60">
            ...
            <div className="bg-white rounded-xl sm:max-w-lg  shadow-2xl dark:bg-neutral-900 dark:shadow-black/70">
                <div className="p-4 md:p-6 h-120 overflow-x-hidden overflow-y-auto">
                    ...
                    <div className="mt-4 space-y-5">
                        ...
                        <div className="flex gap-x-5">
                            <svg className="shrink-0 mt-1 size-5 text-gray-800 dark:text-neutral-200"
                        ...
                        <div className="flex gap-x-5">
                            ...
                            <div className="grow">
                                <p className="text-sm text-gray-800 dark:text-neutral-200">
                                    Provide a safer experience by using information that we receive from cookies on and
                                    off Preline
                                </p>
                            </div>
                        </div>
                    ...
                    <p className="mt-4 text-sm text-gray-800 dark:text-neutral-200">
                        For analytics and to provide certain features and improve our services for you, we use tools
                        from other companies on Preline.
                    </p>

                    <p className="mt-4 text-sm text-gray-800 dark:text-neutral-200">
                        You can allow the use of all cookies, just essential cookies or you can choose more options
                        below. You can learn more about cookies and how we use them, and review or change your choice at
                        any time in our <a
                    ...
                    <div className="mt-5 divide-y divide-gray-200 dark:divide-neutral-700">
                        ...
                        <div className="py-4 first:pt-0 last:pb-0">
                            <button type="button"
                                    ...
                                    id="hs-essential-cookie-collapse" aria-expanded="false"
                            ...
                            <div id="hs-essential-cookie-collapse-heading"
                        ...
                        <div className="py-4 first:pt-0 last:pb-0">
                            <button type="button"
                                    className="hs-collapse-toggle flex w-full justify-between items-center gap-x-5 font-semibold text-gray-800 hover:text-gray-600 focus:outline-hidden focus:text-gray-600 dark:text-neutral-200 dark:hover:text-neutral-300 dark:focus:text-neutral-300"
                                    id="hs-optional-cookie-collapse" aria-expanded="false"
                            ...
                            <div id="hs-optional-cookie-collapse-heading"
                                 className="hs-collapse hidden w-full overflow-hidden transition-[height] duration-300"
                ...
                {/* Footer */}
                <div
                    className="flex border-t border-gray-200 divide-x divide-gray-200 dark:border-neutral-700 dark:divide-neutral-700">
