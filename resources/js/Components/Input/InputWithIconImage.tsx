    ...
    return (
        <div className="max-w-sm space-y-3">
            ...
            <div className="flex rounded-lg mt-2">
                <div
                    className="px-4 inline-flex items-center min-w-fit rounded-s-md border border-e-0 border-gray-200 bg-gray-50 dark:bg-neutral-700 dark:border-neutral-600">
                    <img
                        src={iconSrc}
                        alt={name}
                        className={`${iconClassName} w-4 h-4 rounded`}
