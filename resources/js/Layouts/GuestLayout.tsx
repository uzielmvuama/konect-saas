      ...
      <div className="hs-dropdown [--auto-close:inside] [--placement:bottom-right] fixed inline-flex md:right-8 right-4 md:bottom-8 bottom-6">
        ...
        >
          <div className="h-[605px] relative">
            ...
            <div className="-mt-7 ms-2.5 relative z-10 flex shrink-0 justify-center items-center size-14 bg-white rounded-full dark:bg-neutral-900">
              <a
            ...
            {/* Body */}
            <div className="p-5 h-[445px] overflow-y-auto [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&::-webkit-scrollbar-track]:bg-neutral-700 dark:[&::-webkit-scrollbar-thumb]:bg-neutral-500">
              <div>
              ...
              <div className="mt-5 space-y-5">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex flex-col pb-1 bg-white border border-gray-200 rounded-lg dark:bg-neutral-900 dark:border-neutral-700">
                    <textarea
                      id="hs-pro-chwlmm"
