...
export default function AppLayout({title, showNavbarMenu = true, children}: Props) {
    ...
    const {
        auth: {user},
        jetstream, subscription, permissions
    ...
    return (
        <PrelineProviderLayout>
            ...
            <header className="flex flex-col z-50">
                ...
                {showNavbarMenu && (
                   <AppNavHeader jetstream={jetstream} subscription={subscription} switchToTeam={switchToTeam} user={user} permissions={permissions} all_teams={all_teams} />
                )}
            </header>
            {/* ========== END HEADER ========== */}
            ...
            <main id="content">
                <div className="max-w-[85rem] p-2 sm:p-5 md:pt-5 lg:px-8 mx-auto">
                    ...
                    <DismissableAlert title={__("messages.upgrade_to_plan.title", {
